...
### A modern, responsive asset inventory platform built with React and Flask
...
- **Repair Workflow** - Two-stage repair process with cost tracking
- **Return Processing** - Multiple return types (Inventory, Buyback, Damaged)
